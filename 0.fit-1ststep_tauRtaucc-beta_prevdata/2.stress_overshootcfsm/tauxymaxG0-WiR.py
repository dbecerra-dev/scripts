...
with open('./data/data-beta5-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Nk=244
            beta=5
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x1.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta5-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x2.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta5-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x3.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta5-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x4.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta5-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x5.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta9-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x6.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta9-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x7.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta9-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x8.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta9-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x9.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta9-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x10.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta14-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x11.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta14-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x12.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta14-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x13.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta14-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x14.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta14-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x15.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta20-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x16.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta20-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x17.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta20-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x18.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta20-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x19.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta20-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x20.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta27-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x21.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta27-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x22.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta27-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x23.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta27-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x24.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
with open('./data/data-beta27-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            Z=float((Nk+beta))/float((beta+1))
            Zc=((0.74*(Z-1)+1)-0.515)/0.823
            x25.append(float(row[1])*float(0.0107947*np.exp(0.000875801*Zc)*(-2.93243+6.67297*Zc)**(2.02861))*float(0.265*beta**(2.666)))
...
fig.savefig('tauxymaxG0-WiR-ast.eps', dpi=300, bbox_inches='tight')
#plt.show()
