...
with open('./data/data-beta5-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b1erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))   #1/x*err, liberaliza error por loglog
...
with open('./data/data-beta5-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b2erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta5-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b3erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta5-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b4erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta5-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b5erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta9-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b6erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta9-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b7erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta9-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b8erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta9-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b9erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta9-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b10erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta14-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b11erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta14-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b12erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta14-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b13erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta14-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b14erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta14-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b15erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta20-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b16erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta20-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b17erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta20-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b18erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta20-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b19erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta20-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b20erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta27-NK244-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b21erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta27-NK350-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b22erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta27-NK512-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b23erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta27-NK848-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b24erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
...
with open('./data/data-beta27-NK1500-gammatauk','r') as csvfile:
    ...
    for line in csvfile:
        ...
        for row in plots:
            ...
            b25erro.append(1/float(row[5])*(0.08*np.sqrt(1/(float(row[5]))**2)))
######################################################################################
######################################################################################
######################################################################################
...
ax.scatter(a1, b1,color='none',label=r'$N_{\rm K}=244, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK1,errtauRtauK1) , marker='^', edgecolor='#FA8072', linewidth='4', s=1200)
multiply_list(a2,tauRtauK2)
ax.scatter(a2, b2,color='none',label=r'$N_{\rm K}=350, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK2,errtauRtauK2) , marker='o', edgecolor='#FA8072', linewidth='4', s=1200)
multiply_list(a3,tauRtauK3)
ax.scatter(a3, b3,color='none',label=r'$N_{\rm K}=512, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK3,errtauRtauK3) , marker='s', edgecolor='#FA8072', linewidth='4', s=1200)
multiply_list(a4,tauRtauK4)
ax.scatter(a4, b4,color='none',label=r'$N_{\rm K}=848, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK4,errtauRtauK4) , marker='p', edgecolor='#FA8072', linewidth='4', s=1200)
multiply_list(a5,tauRtauK5)
ax.scatter(a5, b5,color='none',label=r'$N_{\rm K}=1500, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK5,errtauRtauK5) , marker='v', edgecolor='#FA8072', linewidth='4', s=1200)
...
textstr1 = '\n'.join((r'$\angle 0.33$',))
plt.text(0.84, 0.85, textstr1, transform=ax.transAxes, fontsize=70, verticalalignment='top')
...
ax.scatter(a6, b6,color='none',label=r'$N_{\rm K}=244, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK6,errtauRtauK6) , marker='^', edgecolor='#708090', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=244, \langle Z\rangle=42$'
multiply_list(a7,tauRtauK7)
ax.scatter(a7, b7,color='none',label=r'$N_{\rm K}=350, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK7,errtauRtauK7) , marker='o', edgecolor='#708090', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=512, \langle Z\rangle=86$'
multiply_list(a8,tauRtauK8)
ax.scatter(a8, b8,color='none',label=r'$N_{\rm K}=512, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK8,errtauRtauK8) , marker='s', edgecolor='#708090', linewidth='4', s=1200) #r'${\rm FSM}, \beta=5, N_{\rm K}=848, \langle Z\rangle=142$'
multiply_list(a9,tauRtauK9)
ax.scatter(a9, b9,color='none',label=r'$N_{\rm K}=848, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK9,errtauRtauK9) , marker='p', edgecolor='#708090', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=244, \langle Z\rangle=17$'
multiply_list(a10,tauRtauK10)
ax.scatter(a10, b10,color='none',label=r'$N_{\rm K}=1500, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK10,errtauRtauK10) , marker='v', edgecolor='#708090', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=512, \langle Z\rangle=35$'
...
ax.scatter(a11, b11,color='none',label=r'$N_{\rm K}=244, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK11,errtauRtauK11) , marker='^', edgecolor='maroon', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=244, \langle Z\rangle=42$'
multiply_list(a12,tauRtauK12)
ax.scatter(a12, b12,color='none',label=r'$N_{\rm K}=350, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK12,errtauRtauK12) , marker='o', edgecolor='maroon', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=512, \langle Z\rangle=86$'
multiply_list(a13,tauRtauK13)
ax.scatter(a13, b13,color='none',label=r'$N_{\rm K}=512, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK13,errtauRtauK13) , marker='s', edgecolor='maroon', linewidth='4', s=1200) #r'${\rm FSM}, \beta=5, N_{\rm K}=848, \langle Z\rangle=142$'
multiply_list(a14,tauRtauK14)
ax.scatter(a14, b14,color='none',label=r'$N_{\rm K}=848, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK14,errtauRtauK14) , marker='p', edgecolor='maroon', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=244, \langle Z\rangle=17$'
multiply_list(a15,tauRtauK15)
ax.scatter(a15, b15,color='none',label=r'$N_{\rm K}=1500, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK15,errtauRtauK15) , marker='v', edgecolor='maroon', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=512, \langle Z\rangle=35$'
...
ax.scatter(a16, b16,color='none',label=r'$N_{\rm K}=244, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK16,errtauRtauK16) , marker='^', edgecolor='mediumseagreen', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=244, \langle Z\rangle=42$'
multiply_list(a17,tauRtauK17)
ax.scatter(a17, b17,color='none',label=r'$N_{\rm K}=350, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK17,errtauRtauK17) , marker='o', edgecolor='mediumseagreen', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=512, \langle Z\rangle=86$'
multiply_list(a18,tauRtauK18)
ax.scatter(a18, b18,color='none',label=r'$N_{\rm K}=512, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK18,errtauRtauK18) , marker='s', edgecolor='mediumseagreen', linewidth='4', s=1200) #r'${\rm FSM}, \beta=5, N_{\rm K}=848, \langle Z\rangle=142$'
multiply_list(a19,tauRtauK19)
ax.scatter(a19, b19,color='none',label=r'$N_{\rm K}=848, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK19,errtauRtauK19) , marker='p', edgecolor='mediumseagreen', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=244, \langle Z\rangle=17$'
multiply_list(a20,tauRtauK20)
ax.scatter(a20, b20,color='none',label=r'$N_{\rm K}=1500, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK20,errtauRtauK20) , marker='v', edgecolor='mediumseagreen', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=512, \langle Z\rangle=35$'
...
ax.scatter(a21, b21,color='none',label=r'$N_{\rm K}=244, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK21,errtauRtauK21) , marker='^', edgecolor='dodgerblue', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=244, \langle Z\rangle=42$'
multiply_list(a22,tauRtauK22)
ax.scatter(a22, b22,color='none',label=r'$N_{\rm K}=350, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK22,errtauRtauK22) , marker='o', edgecolor='dodgerblue', linewidth='4', s=1200)    #r'${\rm FSM}, \beta=5, N_{\rm K}=512, \langle Z\rangle=86$'
multiply_list(a23,tauRtauK23)
ax.scatter(a23, b23,color='none',label=r'$N_{\rm K}=512, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK23,errtauRtauK23) , marker='s', edgecolor='dodgerblue', linewidth='4', s=1200) #r'${\rm FSM}, \beta=5, N_{\rm K}=848, \langle Z\rangle=142$'
multiply_list(a24,tauRtauK24)
ax.scatter(a24, b24,color='none',label=r'$N_{\rm K}=848, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK24,errtauRtauK24) , marker='p', edgecolor='dodgerblue', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=244, \langle Z\rangle=17$'
multiply_list(a25,tauRtauK25)
ax.scatter(a25, b25,color='none',label=r'$N_{\rm K}=1500, \tau_{\rm R}/\tau_{\rm K}=%7.3f\pm %7.3f$' % (tauRtauK25,errtauRtauK25) , marker='v', edgecolor='dodgerblue', linewidth='4', s=1200)   #r'${\rm FSM}, \beta=14, N_{\rm K}=512, \langle Z\rangle=35$'
